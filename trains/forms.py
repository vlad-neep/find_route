...
class TrainForm(forms.ModelForm):
    name = forms.CharField(label='Train number', widget=forms.TextInput(attrs={'class': 'form-control',
                                                         'placeholder': 'Enter the train number'}))

    travel_time = forms.IntegerField(label='Time in travel', widget=forms.NumberInput(attrs={'class': 'form-control',
